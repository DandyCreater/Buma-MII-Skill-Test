...
class MovieDetailRespModel {
  ...
  factory MovieDetailRespModel.fromJson(Map<String, dynamic> json) =>
      MovieDetailRespModel(
        adult: json["adult"],
  ...
  MovieDetailRespEntity toEntity() {
    return MovieDetailRespEntity(
      adult: adult,
...
class BelongsToCollection {
  ...
  BelongsToCollectionEntity toEntity() {
    return BelongsToCollectionEntity(
        id: id, name: name, posterPath: posterPath, backdropPath: backdropPath);
  }
}
...
class ProductionCountry {
  ...
  ProductionCountryEntity toEntity() {
    return ProductionCountryEntity(iso31661: iso31661, name: name);
  }
}
